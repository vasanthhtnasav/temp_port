...
export function SkillCard({ name, icon: Icon, color, url }: SkillCardProps) {
  return (
    <a 
      ...
      className="group relative flex flex-col items-center p-2 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-lg 
    ...
    >
      ...
      <div className="p-3 rounded-full transition-all duration-300 group-hover:scale-110" style={{ backgroundColor: `${color}1A` }}>
        <Icon size={28} color={color} className="group-hover:brightness-100" />
      </div>
